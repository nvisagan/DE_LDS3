...
- In the Northwind database, what is the type of relationship between the
  ...
  - The relationship between them is a Many to Many. The EmployeeTerritories table connects the two.

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
  - Document Store like MongoDB uses key value pairs and not a paticular schema. It becomes easy to deploy and test rather quickly. This is good for prototyping. At the same time it might be as reliable with sensitive and abundant information like health records.

- What is "NewSQL", and what is it trying to achieve?
    -NewSQL is like a mixture of NoSQL and the practices of ACID. This is trying to achieve that high scalabilty to reach huge corporational databases but with the ease of NoSQL
